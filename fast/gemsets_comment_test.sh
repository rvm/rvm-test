...
rvm current                              # match=/^ruby-1.8.7-p374$/
rvm gemset list                          # match!=/test_gemset/

: rvm ... do
rvm 1.8.7-p374 do rvm gemset create test_gemset            # status=0 ; match=/gemset created/
rvm 1.8.7-p374 do rvm gemset list                          # match=/test_gemset/; match!=/other_gems/
