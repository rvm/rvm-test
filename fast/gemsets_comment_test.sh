...
rvm current                              # match=/^ruby-2.1.1$/
rvm gemset list                          # match!=/test_gemset/

: rvm ... do
rvm 2.1.1 do rvm gemset create test_gemset            # status=0 ; match=/gemset created/
rvm 2.1.1 do rvm gemset list                          # match=/test_gemset/; match!=/other_gems/
