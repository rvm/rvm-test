...
: patch version
rvm use 1.8.7
echo "1.9.3-p392" > $f      # env[GEM_HOME]=/1.8.7/
rvm use .                   # env[GEM_HOME]=/1.9.3-p392/

: full version
rvm use 1.8.7
echo "ruby-1.9.3-p392" > $f # env[GEM_HOME]=/1.8.7/
rvm use .                   # env[GEM_HOME]=/1.9.3-p392/

: gemset
rvm use 1.8.7
echo "veve" > $g            # env[GEM_HOME]=/1.8.7/
rvm use .                   # env[GEM_HOME]=/1.9.3-p392@veve/
